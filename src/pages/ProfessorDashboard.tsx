...
import { GraduationCap, ClipboardCheck, FileText, Sparkles, Settings2, Camera, Save, Loader2 } from 'lucide-react';
        ...
        <Card className="w-full border-none shadow-2xl bg-zinc-900 rounded-[2.5rem] overflow-hidden">
          <CardContent className="p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleSaveSetup} disabled={saving || uploading} className="w-full bg-study-primary text-zinc-900 rounded-xl font-black h-14 text-sm uppercase tracking-widest shadow-lg active:scale-95 transition-all">
